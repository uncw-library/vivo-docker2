...
<div id="map-of-science-response">
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 id="header-entity-label" class="hide-dom-on-init">
                <span>
                    <a id="entityMoniker" href="${entityVivoProfileURL}" title="${i18n().entity_label}">${entityLabel}</a>
                </span>
            </h2>
            ...
            <div id="left-column" class="hide-dom-on-init">
            	<div id="notification-container" style="display:none">
                    <div id="error-notification" class="ui-state-error" style="padding:10px; -moz-box-shadow:0 0 6px #980000; -webkit-box-shadow:0 0 6px #980000; box-shadow:0 0 6px #980000;">
                        <a class="ui-notify-close" href="#" title="${i18n().error_notification}">
                        ...
                        <p style="text-align:center">
                            <a class="ui-notify-close" href="#">${i18n().close_me}</a>
                        </p>
                    </div>
                ...
                <div id="view-type-filter" style="display:${viewTypeFilterDisplay};">
                	...
                	<img class="filterInfoIcon" id="exploreInfoIcon" src="${urls.images}/iconInfo.png" alt="${i18n().info_icon}" title="" />
                    <br>
            		<input type="radio" name="view-type" value="COMPARISON"> ${i18n().compare_organizations} <#--/ people --></input>
            		<img class="filterInfoIcon" id="compareInfoIcon" src="${urls.images}/iconInfo.png" alt="${i18n().info_icon}" title="" />
                    <br><br>
                </div>
...
<div id="error-container">
    ...
    <div id="error-body">
        <p>
            <span id="variable-error-text">${i18n().no_publications_for_this_organization}</span>
            <hr /> 
            ${i18n().please_visit} ${entityLabel}
            <a href="${entityVivoProfileURL}">${i18n().profile_page}</a>
            ${i18n().for_complete_overview}
        </p>
    </div>
</div>
